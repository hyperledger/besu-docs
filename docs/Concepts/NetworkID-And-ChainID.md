...
Nodes need to have a matching [genesis file](../how-to/configure/Genesis-File.md), including the chain ID, in order to peer.
...
2. Update the [genesis file](../how-to/configure/Genesis-File.md) with the new chain ID.
