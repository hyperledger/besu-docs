...
To enable access to the [JSON-RPC API](../Interact/Pantheon-APIs/Using-JSON-RPC-API.md), open the HTTP JSON-RPC and WebSockets JSON-RPC ports to the intended users 
