...
| **baseFeePerGas**    | Quantity              | The block's [base fee per gas](../Concepts/Transactions/Transaction-Types.md#eip1559-transactions); the baseFee is burned. Before [EIP-1559](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1559.md), this field must empty. After EIP-1559, this field must be set to the block's base fee per gas value. |
