...
The minimum price that a transaction offers for it to be included in a mined block. To retrieve this price in a running node later, use [`eth_gasPrice`](../API-Methods.md#eth_gasprice).
The default is 1000.
