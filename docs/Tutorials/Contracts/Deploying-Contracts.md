...
## 1. Use `eth_sendSignedTransaction`
...
stronger security.
Instead, Besu uses [EthSigner](https://github.com/ConsenSys/ethsigner) paired with Besu to make the
...
EthSigner.
You can refer to the [EthSigner documentation](https://docs.ethsigner.consensys.net/en/latest/) for more details on
configuration.
