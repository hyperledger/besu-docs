...
Call [`eth_blockNumber`](../Reference/API-Methods.md#eth_blockNumber) to retrieve the number of the most recently
synchronized block:
...
[`perm_addNodesToAllowlist`](../Reference/API-Methods.md#perm_addnodestoallowlist) API method on existing nodes to add
...
or via [RPC API calls](../Reference/API-Methods.md#perm_addnodestoallowlist).
