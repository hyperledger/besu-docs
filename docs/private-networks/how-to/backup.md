...
[separate volume to store data](../../get-started/install/run-docker-image.md#starting-besu). Use the
...
<!-- Links -->
[finding peers after upgrading and restarting]: ../../how-to/upgrade/node.md#finding-peers-on-restarting
