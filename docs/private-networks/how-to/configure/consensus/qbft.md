...
Hyperledger Besu implements the QBFT proof of authority (PoA) [consensus protocol](index.md).
...
[`public-key export-address`](../../../../reference/cli/subcommands.md#export-address) Besu
