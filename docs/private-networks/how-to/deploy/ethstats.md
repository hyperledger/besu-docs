...
Start a node using the [`--ethstats`](../../../global/reference/cli/options.md#ethstats) option to specify the Ethstats server URL.
You can specify a contact email to send to the server using [`--ethstats-contact`](../../../global/reference/cli/options.md#ethstats-contact).
