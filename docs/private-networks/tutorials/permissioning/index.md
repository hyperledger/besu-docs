...
Use the [`perm_addNodesToAllowlist`](../../../global/reference/api/index.md#perm_addnodestoallowlist) JSON-RPC API method to add permissioned nodes after starting the nodes.
...
- Nodes and accounts permissions using [`--permissions-nodes-config-file-enabled`](../../../global/reference/cli/options.md#permissions-nodes-config-file-enabled)
  and [`--permissions-accounts-config-file-enabled`](../../../global/reference/cli/options.md#permissions-accounts-config-file-enabled).
- The JSON-RPC API using [`--rpc-http-enabled`](../../../global/reference/cli/options.md#rpc-http-enabled).
...
When the node starts, the [enode URL](../../../global/concepts/node-keys.md#enode-url) displays. You need the
...
- A data directory for Node-2 using [`--data-path`](../../../global/reference/cli/options.md#data-path).
- Other options as for [Node-1](#7-start-node-1).

When the node starts, the [enode URL](../../../global/concepts/node-keys.md#enode-url) displays. You need
...
- A data directory for Node-3 using [`--data-path`](../../../global/reference/cli/options.md#data-path).
- Other options as for [Node-1](#7-start-node-1).
...
- A data directory for Node-4 using [`--data-path`](../../../global/reference/cli/options.md#data-path).
- Other options as for [Node-1](#7-start-node-1).
...
[`perm_addNodesToAllowlist`](../../../global/reference/api/index.md#perm_addnodestoallowlist) JSON-RPC API
...
Use the [`admin_addPeer`](../../../global/reference/api/index.md#admin_addpeer) JSON-RPC API method to add
...
Use curl to call the JSON-RPC API [`net_peerCount`](../../../global/reference/api/index.md#net_peercount) method and confirm the
...
[`net_peerCount`](../../../global/reference/api/index.md#net_peercount) method:
