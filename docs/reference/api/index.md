...
`result`: *array* of *objects* - list of [log objects](objects.md#log-object), or an empty list if nothing has
...
for public contracts except there is no [automatic log bloom caching](../cli/options.md#auto-log-bloom-caching-enabled)
...
except there is no [automatic log bloom caching](../cli/options.md#auto-log-bloom-caching-enabled)
for private contracts.
