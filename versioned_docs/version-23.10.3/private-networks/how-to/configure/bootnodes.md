...
A network must have at least one operating bootnode. To allow for continuity in the event of failure, configure two or more bootnodes in a production network. In case no bootnodes are entered, Mainnet default bootnodes will be used.
