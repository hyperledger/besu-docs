...
When using [Bonsai Tries](../../concepts/data-storage-formats.md#bonsai-tries), the [maximum number of layers back](../../concepts/data-storage-formats.md#accessing-data) Bonsai can reconstruct a historical state. The default is 512.
...
Name of the [security module plugin](https://docs.quorumplugins.consensys.net/) to use. For example, a Hardware Security Module (HSM) or V3 filestore plugin.
